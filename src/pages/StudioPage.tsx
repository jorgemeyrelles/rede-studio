...
export default function StudioPage() {
  ...
  return (
    <main className="mx-auto grid max-w-[1600px] grid-cols-1 gap-3 p-4 lg:grid-cols-[260px_1fr]">
      <LegendPanel />
      ...
      <section className="space-y-3">
        ...
        <div className="rounded-lg border border-[#315072] bg-[#0b172a]/75 px-3 py-2 text-xs text-slate-300">
